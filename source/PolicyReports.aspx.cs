...
public partial class PolicyReports : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter adp;
    ...
    void bindgrid1()
    {
        ...
        adp1 = new SqlDataAdapter("select  policyno,policyname,apdate,ddate,damount from policydetails where accno=@accno and month(apdate)=@mon and year(apdate)=@year ", con);
    ...
    void bindgrid2()
    {
        GridView1.Visible = true;
        Label3.Text = "AccountNo:" + Session["accountno"].ToString();
        adp1 = new SqlDataAdapter("select  policyno,policyname,apdate,ddate,damount from policydetails where accno=@accno and  year(apdate)=@year ", con);
    ...
    void bindgrid3()
    {
        GridView1.Visible = true;
        Label3.Text = "AccountNo:" + Session["accountno"].ToString();
        adp1 = new SqlDataAdapter("select  policyno,policyname,apdate,ddate,damount from policydetails where accno=@accno  ", con);
