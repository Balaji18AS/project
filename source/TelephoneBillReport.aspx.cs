...
public partial class TelephoneBillReport : System.Web.UI.Page
{
    SqlConnection con;
    SqlDataAdapter adp;
    SqlCommand cmd;
    ...
    void bindgrid1()
    {
        ...
        adp1 = new SqlDataAdapter("select  tnumber,planname,pdate,amount from telephonedetails where accno=@accno and month(pdate)=@mon and year(pdate)=@year ", con);
    ...
    void bindgrid2()
    {
        GridView1.Visible = true;
        Label3.Text = "AccountNo:" + Session["accountno"].ToString();
        adp1 = new SqlDataAdapter("select  tnumber,planname,pdate,amount from telephonedetails where accno=@accno and  year(pdate)=@year ", con);
    ...
    void bindgrid3()
    {
        GridView1.Visible = true;
        Label3.Text = "AccountNo:" + Session["accountno"].ToString();
        adp1 = new SqlDataAdapter("select  tnumber,planname,pdate,amount from telephonedetails where accno=@accno  ", con);
