...
public partial class EBBillDetails : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataReader rs;
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.Parameters.AddWithValue("@ebno", TextBox1.Text);
            ...
            if (n != 0)
            {
                cmd = new SqlCommand("insert into ebdetails(accno,ebno,pdate,amount) values(@accno,@ebno,@pdate,@amount)", con);
                cmd.Parameters.AddWithValue("@accno", Label2.Text);
                cmd.Parameters.AddWithValue("@ebno", TextBox1.Text);
                cmd.Parameters.AddWithValue("@pdate", Label3.Text);
                cmd.Parameters.AddWithValue("@amount", TextBox2.Text);
                ...
                if (n1 != 0)
                {
                    ...
                    cmd.Parameters.AddWithValue("@type", "EB");
