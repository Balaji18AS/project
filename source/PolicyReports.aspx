<%@ Page Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true" CodeFile="PolicyReports.aspx.cs" Inherits="PolicyReports"  %>
            ...
            <td colspan="2" style="text-align: center">
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                       ...
                       <asp:BoundField DataField ="apdate" HeaderText ="Amount Payment Date" HtmlEncode ="false" DataFormatString ="{0:dd-MMM-yyyy}" />
                       <asp:BoundField DataField ="ddate" HeaderText ="Due Date"  HtmlEncode ="false" DataFormatString ="{0:dd-MMM-yyyy}"/>
                       <asp:BoundField DataField ="damount" HeaderText ="Due Amount" />
                    </Columns>
